...
ordi_plot(varespec_pca, display="sites", geom="text") 

# Plot PC1 and PC2 of the species
ordi_plot(varespec_pca, display="species") 
```
...
than simply points. Species plots default to text.
...
ordi_plot(varespec_ca, display="sites", geom="text") 

# Plot CA1 and CA2 of the species
ordi_plot(varespec_ca, display="species") 
```
