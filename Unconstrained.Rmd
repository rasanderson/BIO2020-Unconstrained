...
ordi_plot(dune_pca, layers="species") %>% 
...
points. I've added `geom="text"` to ensure quadrat numbers are displayed.
...
autoplot(varespec_pca, layers="sites", legend.position="none", geom="text") 

# Plot PC1 and PC2 of the species
autoplot(varespec_pca, layers="species", legend.position="none", arrows=FALSE) 
```
...
autoplot(varespec_ca, layers="sites", legend.position="none", geom="text") 

# Plot CA1 and CA2 of the species
autoplot(varespec_ca, layers="species", legend.position="none", arrows=FALSE, geom="text") 
```
