...
little confusing for beginners, so in the `nes8010.R` script is a wrapper
...
ordi_plot(dune_pca, layers="sites", geom="text") + 
  ggtitle("PC1 and PC2 of dune data (quadrat numbers)") +
  xlim(-2, 2.85) +
  ylim(-2.4, 2.2)

# Display plant species PCA scores for axes 1 and 2
ordi_plot(dune_pca, layers="species", geom="text") +
  ggtitle("PC1 and PC2 of dune data showing species codes") +
  xlim(-2, 2.85) +
  ylim(-2.4, 2.2)
```
